...
[![CI](https://github.com/BlackFoxgamingstudio/supervisor-dispatch/actions/workflows/ci.yml/badge.svg)](https://github.com/BlackFoxgamingstudio/supervisor-dispatch/actions/workflows/ci.yml)
...
| **REST Gateway** | ✅ Live on Port `8792` | `POST /api/v1/execute`, `GET /health` |
